...
// get first day of today as default
...
const getMonth = (firstDayOfMonth) => {
    days = ref([]);

    const slotsToFill = today.value.getDay() + 1; // return an index 0-6, 0 being sunday
    ...
    while (day.getMonth() === firstDayOfMonth.getMonth()) {
        const isToday = day.getDate() === today.value.getDate()+1;
...
getMonth(getFirstDayOfMonth(today.value));

const moveForwardOneMonth = () => {
    today.value = new Date(today.value.getFullYear(), today.value.getMonth() + 1, 1)
    getMonth(getFirstDayOfMonth(today.value));
}

const moveBackOneMonth = () => {
    today.value = new Date(today.value.getFullYear(), today.value.getMonth() - 1, 1)
    getMonth(getFirstDayOfMonth(today.value));
}
</script>
